...
public class SessionDialog {
    ...
    public SessionInfo open() {
        ...
        final br.com.quatorzebis.ssh.model.ConfigurationSettings[] config = {
            editing != null
                ? br.com.quatorzebis.ssh.model.ConfigurationSettings.fromSession(editing)
                : br.com.quatorzebis.ssh.storage.SessionDefaults.get()
        };
